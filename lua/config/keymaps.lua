...
keymap("t", "<leader>to", ":tabnew<cr>", { desc = "Open new tab" })
keymap("t", "<leader>tc", ":tabclose<cr>", { desc = "Close current tab" })
keymap("t", "<leader>tn", ":tabnext<cr>", { desc = "Move to next tab" })
keymap("t", "<leader>tp", ":tabprevious<cr>", { desc = "Move to previous tab" })
...
-- documentation Navigation keymap
keymap("n", "<leader>gd", function()
    vim.lsp.buf.definition({ reuse_win = true })
end, { desc = "go to definition (reuse window)" })
